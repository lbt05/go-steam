...
func TestIAuthenticationService_RevokeToken_TransportError(t *testing.T) {
	t.Parallel()
	...
	// Act: revoke token
	response, err := service.RevokeToken(t.Context(), iauthenticationservice.RevokeTokenParameters{})
