...
// Source: github.com/lbt05/go-steam/connection (interfaces: Dialer)
//
// Generated by this command:
//
//	mockgen -package=connection_test -destination=mock_dialer_test.go github.com/lbt05/go-steam/connection Dialer
//
