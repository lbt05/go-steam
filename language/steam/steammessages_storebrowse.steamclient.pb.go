...
const file_steammessages_storebrowse_steamclient_proto_rawDesc = "" +
	...
	"\fdata_request\x18\x03 \x01(\v2\x1b.StoreBrowseItemDataRequestR\vdataRequest\"\xb4B\n" +
	"\tStoreItem\x12F\n" +
...
var file_steammessages_storebrowse_steamclient_proto_depIdxs = []int32{
	...
	43, // 50: StoreItem.Reviews.summary_language_specific:type_name -> StoreItem.Reviews.StoreReviewSummary
	44, // 51: StoreItem.BasicInfo.publishers:type_name -> StoreItem.BasicInfo.CreatorHomeLink
	44, // 52: StoreItem.BasicInfo.developers:type_name -> StoreItem.BasicInfo.CreatorHomeLink
	44, // 53: StoreItem.BasicInfo.franchises:type_name -> StoreItem.BasicInfo.CreatorHomeLink
	45, // 54: StoreItem.Platforms.vr_support:type_name -> StoreItem.Platforms.VRSupport
	59, // 55: StoreItem.Platforms.steam_deck_compat_category:type_name -> ESteamDeckCompatibilityCategory
	60, // 56: StoreItem.Platforms.steam_os_compat_category:type_name -> ESteamOSCompatibilityCategory
	46, // 57: StoreItem.PurchaseOption.active_discounts:type_name -> StoreItem.PurchaseOption.Discount
	47, // 58: StoreItem.PurchaseOption.recurrence_info:type_name -> StoreItem.PurchaseOption.RecurrenceInfo
	48, // 59: StoreItem.Screenshots.all_ages_screenshots:type_name -> StoreItem.Screenshots.Screenshot
	48, // 60: StoreItem.Screenshots.mature_content_screenshots:type_name -> StoreItem.Screenshots.Screenshot
	50, // 61: StoreItem.Trailers.highlights:type_name -> StoreItem.Trailers.Trailer
	50, // 62: StoreItem.Trailers.other_trailers:type_name -> StoreItem.Trailers.Trailer
	5,  // 63: StoreItem.Link.link_type:type_name -> EStoreLinkType
	2,  // 64: StoreItem.Reviews.StoreReviewSummary.review_score:type_name -> EUserReviewScore
	3,  // 65: StoreItem.Trailers.Trailer.trailer_category:type_name -> ETrailerCategory
	49, // 66: StoreItem.Trailers.Trailer.trailer_480p:type_name -> StoreItem.Trailers.VideoSource
	49, // 67: StoreItem.Trailers.Trailer.trailer_max:type_name -> StoreItem.Trailers.VideoSource
	49, // 68: StoreItem.Trailers.Trailer.microtrailer:type_name -> StoreItem.Trailers.VideoSource
	6,  // 69: CStoreBrowse_GetStoreCategories_Response.Category.type:type_name -> EStoreCategoryType
	10, // 70: StoreBrowse.GetItems:input_type -> CStoreBrowse_GetItems_Request
	15, // 71: StoreBrowse.GetStoreCategories:input_type -> CStoreBrowse_GetStoreCategories_Request
	17, // 72: StoreBrowse.GetContentHubConfig:input_type -> CStoreBrowse_GetContentHubConfig_Request
	19, // 73: StoreBrowse.GetPriceStops:input_type -> CStoreBrowse_GetPriceStops_Request
	21, // 74: StoreBrowse.GetDLCForApps:input_type -> CStoreBrowse_GetDLCForApps_Request
	23, // 75: StoreBrowse.GetDLCForAppsSolr:input_type -> CStoreBrowse_GetDLCForAppsSolr_Request
	25, // 76: StoreBrowse.GetHardwareItems:input_type -> CStoreBrowse_GetHardwareItems_Request
	14, // 77: StoreBrowse.GetItems:output_type -> CStoreBrowse_GetItems_Response
	16, // 78: StoreBrowse.GetStoreCategories:output_type -> CStoreBrowse_GetStoreCategories_Response
	18, // 79: StoreBrowse.GetContentHubConfig:output_type -> CStoreBrowse_GetContentHubConfig_Response
	20, // 80: StoreBrowse.GetPriceStops:output_type -> CStoreBrowse_GetPriceStops_Response
	22, // 81: StoreBrowse.GetDLCForApps:output_type -> CStoreBrowse_GetDLCForApps_Response
	24, // 82: StoreBrowse.GetDLCForAppsSolr:output_type -> CStoreBrowse_GetDLCForAppsSolr_Response
	27, // 83: StoreBrowse.GetHardwareItems:output_type -> CStoreBrowse_GetHardwareItems_Response
