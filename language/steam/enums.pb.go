...
const (
	...
	EContentReportResolution_k_EContentReportResolution_MAX        EContentReportResolution = 5
)
...
var (
	EContentReportResolution_name = map[int32]string{
		...
		5: "k_EContentReportResolution_MAX",
	}
...
const file_enums_proto_rawDesc = "" +
	...
	"\x12 \n" +
	"\x1ck_EContentModeratorLevel_MAX\x10\v*\x91\x02\n" +
...
var file_enums_proto_goTypes = []any{
	...
	(EEnhancedMarketAppearanceStatus)(0),          // 68: EEnhancedMarketAppearanceStatus
	(EContentReportSubjectType)(0),                // 69: EContentReportSubjectType
